#!/usr/bin/env bash
# =============================================================================
# Chasqui Assistant — Restauración de un respaldo
# -----------------------------------------------------------------------------
# USO:
#     bash scripts/restaurar.sh backups/chasqui-assistant-chasqui-assistant-20260730-023000.dump
...
if ! command -v docker >/dev/null 2>&1; then
    rojo "ERROR: no se encontró 'docker'. Instálelo o ejecute este script en el servidor de la clínica."
    exit 1
fi
...
POSTGRES_USER="${POSTGRES_USER:-chasqui_assistant}"
POSTGRES_DB="${POSTGRES_DB:-chasqui_assistant}"
...
rojo "  turnos, consultas, movimientos de inventario, pagos y caja."
echo
