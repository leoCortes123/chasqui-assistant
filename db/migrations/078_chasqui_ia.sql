-- =====================================================================
-- Chasqui Assistant — 078_chasqui_ia.sql
...
BEGIN
  ...
  RETURN jsonb_build_object(
    'clinica',        config_txt('nombre_clinica', 'Chasqui Assistant'),
...
BEGIN
  ...
  RETURN '💬 <b>Habla con Chasqui</b>' || E'\n\n' ||
         ...
         esc(config_txt('nombre_clinica', 'Chasqui Assistant')) || ' y también te explico cómo ' ||
...
-- ---------------------------------------------------------------------
GRANT SELECT, INSERT, UPDATE, DELETE ON ia_mensaje, ia_accion_pendiente TO chasqui_assistant_app;
GRANT SELECT ON ia_herramienta TO chasqui_assistant_app;
GRANT USAGE, SELECT ON SEQUENCE ia_mensaje_id_seq TO chasqui_assistant_app;
GRANT SELECT ON ia_mensaje, ia_accion_pendiente, ia_herramienta TO chasqui_assistant_lectura;
