-- =====================================================================
-- Chasqui Assistant — 095_seed_nucleo.sql
...
INSERT INTO config (clave, valor, tipo, descripcion, editable_ui) VALUES
  ('nombre_clinica',     'la clínica',     'texto',
   'Nombre con el que el asistente se refiere a la clínica', true),
  ('zona_horaria',       'America/Bogota', 'texto',
   'Zona horaria operativa de la clínica', false),
...
-- Sin consultorios sembrados: este proyecto agenda equipos de imagen, no
-- salas de consulta. La tabla se conserva porque `sede_id` la acompaña por
-- todas partes y cuesta treinta líneas, pero nace vacía.
