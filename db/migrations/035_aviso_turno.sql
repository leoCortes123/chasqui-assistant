-- ===========================================================================
-- Chasqui Assistant — control de avisos ya enviados a un turno
-- ---------------------------------------------------------------------------
-- Por qué existe:
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'chasqui_assistant_app') THEN
    GRANT SELECT, INSERT, DELETE ON aviso_turno_enviado TO chasqui_assistant_app;
  END IF;
END
$$;
