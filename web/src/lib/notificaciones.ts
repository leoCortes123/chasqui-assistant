...
const global_ = globalThis as unknown as { __chasqui_assistantHub?: Hub };

function hub(): Hub {
  if (!global_.__chasqui_assistantHub) {
    global_.__chasqui_assistantHub = {
      cliente: null,
      conectando: null,
      oyentes: new Set(),
      reintento: null,
  ...
  return global_.__chasqui_assistantHub;
}
